...
CREATE TABLE TipoPreparatoria(
	idTipoPreparatoria int IDENTITY,
	nombre varchar (50) not null,
	estatus bit default 1 not null,
	idUsuarioCrea int not null,
	fechaCrea datetime not null default CURRENT_TIMESTAMP,
...
CREATE TABLE AlumnoDocumento(
	idAlumnoDocumento int IDENTITY,
	idAlumno int not null,
...
CREATE TABLE AsignaturaCarrera(
	idAsignaturaCarrera int not null,
	idAsignatura int not null,
	idCarrera int not null,
	estatus bit default 1 not null,
	idUsuarioCrea int not null,
...
(
idEmpleadoDocumento int IDENTITY,
idEmpleado int not null,
idDocumento int not null,
fechaEntrega date not null,
estatus bit default 1,
...
ALTER TABLE Area
ADD CONSTRAINT FKAreaDepartamento FOREIGN KEY (idDepartamento)
...
ADD CONSTRAINT FKDepartamentoArea FOREIGN KEY (idArea)
REFERENCES Area(idArea)
...
ALTER TABLE Visita
ADD CONSTRAINT FKVisitaAsignatura FOREIGN KEY (idAsignatura)
